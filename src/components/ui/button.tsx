...
const variantStyles: Record<ButtonVariant, string> = {
  primary:
    'bg-ink text-paper shadow-sm hover:opacity-95 focus:ring-accent/60',
  secondary:
    'border border-ink/15 bg-paper text-ink hover:border-ink/25 focus:ring-accent/50',
  ghost: 'text-ink/70 hover:text-ink',
  inverse:
    'bg-paper text-ink hover:opacity-95 focus:ring-accent/70',
};
